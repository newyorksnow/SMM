"""
Model validation: cumulative bite-count model (scenario ii, k_j = 0)
...
def model(t: np.ndarray, beta: float = BETA, l: float = L) -> np.ndarray:
    """Cumulative bite-count model, scenario ii (k_j = 0, a_ij = 1).
...
# ─────────────────────────────────────────────
print("=" * 70)
print("  MODEL VALIDATION  |  beta = 0.01980  |  l = 0.00474")
